...
---
# Methods for calclating the threshold
...
- Combination of susceptibility (spatial perspective) and rainfall thresholds (temporal perspective)

- Future: Satellite data and probabilistic, Bayesian, rainfall thresholds
---
...
##- Still appealing: Bayesian approach as in Berti et al. 2012 in combination with landslide susceptibility

##- Do less, in more depth rather than more, shallow
