...
<br>
- I'll show some of the most interesting aspects from this process
...
## I decided that 5 % the data should stay below the threshold

## So a good threshold will have 5 % of new, unseen, data below the threshold?
...
- We rarely know anything why a landslide really was triggered
...
- Deterministic thresholds are very complicated to validate

- Probabilistic thresholds seem to be more statistically sounds approach
---
...
- Bayesian approach as in Berti et al. 2012
